...
const ARCHETYPES = [
  ...
  {
    id: "medical-truth",
    name: "The Medical Truth",
    tagline: "What your doctor didn't have time to explain.",
    icon: "⊕",
    palette: { bg: "#030a0a", accent: "#06b6d4", glow: "rgba(6,182,212,0.15)" },
    identity: "Deep teal, clinical white, dark navy — trustworthy and precise",
    tone: "Clear, calm, authoritative. You simplify without dumbing down.",
    niche: "Health & Medicine",
    angle: "Beginner-friendly",
    intensity: 5,
    controversy: 4,
    topics: ["What most people get wrong about common medications", "The symptom doctors dismiss that you should take seriously", "How the body actually heals — and what slows it down"],
  },
  {
    id: "economics-explained",
    name: "Economics Explained",
    tagline: "The forces shaping your life — finally made clear.",
    icon: "⊞",
    palette: { bg: "#060608", accent: "#818cf8", glow: "rgba(129,140,248,0.15)" },
    identity: "Deep violet, indigo, clean white — academic but accessible",
    tone: "Analytical and grounded. You connect abstract systems to real everyday life.",
    niche: "Economics & Finance",
    angle: "Data-driven",
    intensity: 6,
    controversy: 5,
    topics: ["Why inflation hits some people harder than others", "The economic policy nobody talks about that affects everything", "How markets actually work vs what you were taught in school"],
  },
  {
    id: "knowledge-architect",
    name: "The Knowledge Architect",
    tagline: "Complex ideas. Human language. No condescension.",
    icon: "⊟",
    palette: { bg: "#06060a", accent: "#a78bfa", glow: "rgba(167,139,250,0.15)" },
    identity: "Deep purple, lavender, white — intellectual and warm",
    tone: "Patient, thorough, genuinely curious. You teach because you love the subject.",
    niche: "Education",
    angle: "Beginner-friendly",
    intensity: 5,
    controversy: 3,
    topics: ["The concept that took scientists 200 years to understand — explained in 10 minutes", "Why most people learn things in the wrong order", "The idea behind everything you take for granted"],
  },
];
        ...
        <div className="p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 mb-5">
            <div className="flex items-baseline gap-2 mb-4">
              ...
              <div className="text-neutral-400 text-sm">one-time</div>
            </div>
            ...
            <a href="https://leonardus27.gumroad.com/l/sxsmi" target="_blank" rel="noopener noreferrer"
              className="mt-5 w-full rounded-2xl bg-amber-300 py-3 font-bold text-black hover:bg-amber-200 transition text-sm block text-center">
              Get ChannelForge Pro — $9
            </a>
            <div className="mt-2 text-xs text-center text-neutral-600">One-time payment · Instant access · Via Gumroad</div>
          </div>
    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      {phase === "landing" && (
        <div className="relative min-h-screen flex flex-col items-center justify-center px-5 overflow-hidden">
          ...
          <div className="absolute top-20 left-1/2 -translate-x-1/2 flex gap-1 bg-white/10 rounded-full p-1 border border-white/20">
            <button
      ...
      {phase === "results" && strategy && (
        <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto px-5 py-10 space-y-5">
            ...
            {/* Human CTA */}
            <Reveal step={revealStep} threshold={14}>
              <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 text-center">
                <div className="text-3xl mb-4">🙏</div>
                <h3 className="text-xl font-bold text-white mb-3">A honest note from the person who built this.</h3>
                <p className="text-white/50 text-sm leading-7 max-w-lg mx-auto mb-4">
                  I'm a solo creator of very modest means. I built CreatorOS before I even had a channel — because I needed it myself, and figured others did too. No team, no funding, no safety net. Just a laptop and a lot of late nights.
                </p>
                <p className="text-white/50 text-sm leading-7 max-w-lg mx-auto mb-6">
                  If this tool saved you time or gave you one good idea — the best thing you can do is share it with another creator who's stuck. That's genuinely how something like this survives.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    onClick={() => {
                      const text = `This free tool generates a complete YouTube channel strategy in seconds — titles, hooks, thumbnails, monetization. No account needed.\n\nchannelforge.tech`;
                      navigator.clipboard.writeText(text);
                      alert("Link copied — share it with someone building a channel.");
                    }}
                    className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-6 py-3 text-sm text-white hover:bg-white/[0.08] transition"
                  >
                    <Share2 className="h-4 w-4" /> Share this tool
                  </button>
                  <a
                    href="mailto:leondedaly@gmail.com?subject=CreatorOS feedback"
                    className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-6 py-3 text-sm text-white hover:bg-white/[0.08] transition"
                  >
                    💬 Send me feedback
                  </a>
                </div>
                <p className="mt-5 text-xs text-white/20">Built by one person. Powered by stubbornness.</p>
              </div>
            </Reveal>
